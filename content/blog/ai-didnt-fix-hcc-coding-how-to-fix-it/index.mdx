---
title: 70% of AI-Generated HCC Suspects Were Rejected. Here's Why That Happens
date: '2026-04-09'
thumbnail: /assets/blog/ai-didnt-fix-hcc-coding-how-to-fix-it/cover.jpg
...
definedTerm:
  ...
  description: A risk adjustment mechanism used in Medicare Advantage and value-based care where diagnoses are grouped into risk categories to predict future healthcare costs and determine reimbursement amounts.
---

![How Martlet AI builds audit-ready evidence: encounter-linked, evidence-backed, MEAT-validated, with a ~70% provider selection rate](/assets/blog/ai-didnt-fix-hcc-coding-how-to-fix-it/ai-didnt-fix-hcc-coding-how-to-fix-it-infographic.jpg)
