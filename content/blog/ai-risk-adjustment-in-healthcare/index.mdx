---
title: 'What AI actually does to risk adjustment accuracy — and where it still falls short'
date: '2026-06-23'
...
- Hasham Ul Haq
definedTerm:
  name: AI Risk Adjustment
  description: The use of natural language processing and machine learning to read clinical documentation at scale, surface HCC-eligible diagnoses, suggest accurate ICD-10-CM codes, and predict RAF score gaps before submission — operating under the same documentation and compliance requirements as manual risk adjustment.
---

![AI Risk Adjustment: from diagnosis capture to claim validation — Martlet Clinical NLP, larger population, real-time coding, denial prevention](/assets/blog/ai-risk-adjustment-in-healthcare/ai-risk-adjustment-in-healthcare-infographic.jpg)
