...
- Hasham Ul Haq
definedTerm:
  name: CMS-HCC V28 (100% Phase-In)
  description: The CMS Hierarchical Condition Categories risk adjustment model for Medicare Advantage that reached full implementation in payment year 2026, mapping 7,770 ICD-10-CM codes to 115 HCCs across 26 condition families — a net reduction of 2,027 payable diagnosis codes compared to the prior V24 model.
---
