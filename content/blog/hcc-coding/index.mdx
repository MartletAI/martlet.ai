---
title: 'What is HCC coding and why does it determine your Medicare Advantage revenue?'
date: '2026-06-10'
...
- Hasham Ul Haq
definedTerm:
  name: Hierarchical Condition Category (HCC) Coding
  description: A risk adjustment methodology CMS uses to estimate patient disease burden and calibrate reimbursement in Medicare Advantage and value-based programs, mapping documented ICD-10 diagnoses to Condition Categories that combine with demographics to produce a Risk Adjustment Factor (RAF) score.
---
