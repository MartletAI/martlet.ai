---
title: 'HCC risk adjustment coding: the documentation mistakes that trigger RADV audits'
date: '2026-07-07'
...
definedTerm:
  ...
  description: The process of assigning ICD-10-CM diagnosis codes to patient encounters and mapping them to Hierarchical Condition Categories that contribute to a member's RAF score, which in Medicare Advantage determines the monthly per-member payment CMS makes to health plans.
---
