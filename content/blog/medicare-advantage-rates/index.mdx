---
title: 'Medicare Advantage rate changes in 2026: what risk adjustment leaders need to do now'
date: '2026-07-09'
...
- Ritwik Jain
definedTerm:
  name: Medicare Advantage Rates
  description: The monthly per-member payments CMS makes to private health plans administering Medicare Advantage coverage, calculated from county benchmarks, plan bids, and risk adjustment (RAF) scores derived from HCC coding.
---
