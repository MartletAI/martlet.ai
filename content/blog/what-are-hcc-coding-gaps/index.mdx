---
title: 'HCC coding gaps: how to find them before CMS does'
date: '2026-07-14'
...
definedTerm:
  name: HCC Coding Gap
  description: A chronic condition that is clinically present in a patient's health history but missing or incomplete in their risk adjustment data submission, causing RAF scores to underrepresent the patient's actual health complexity due to documentation habits, annual recapture failures, or coding specificity issues.
---
