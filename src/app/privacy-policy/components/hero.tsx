...
export function Hero() {
  return(
    <section className="gradient-privacy-policy-hero pt-[156px] pb-10 relative overflow-hidden">
      <div className="container-main mx-auto flex flex-col justify-center relative z-10">
        <div className="mx-auto flex w-[188px] h-[37px] px-4 py-1.5 justify-center items-center gap-1.5 rounded-full bg-white shadow-[0_2px_4px_0_rgba(0,0,0,0.10)] mb-11.5">
          ...
          <p className="text-black font-medium text-[14px]">Privacy Policy</p>
        </div>
        <h1 className="flex flex-wrap justify-center text-center font-extrabold text-[64px] leading-[77px] tracking-[-0.02em] mx-auto">
          <span className="gradient-privacy-policy-text-primary block">Privacy Policy for Martlet AI</span>
        </h1>
