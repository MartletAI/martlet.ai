      ...
      <div className="mb-11.5 flex flex-col justify-center items-center gap-16 self-stretch max-w-container mx-auto bg-white rounded-xl border border-black/8 shadow-[0_6px_20.6px_0_rgba(0,0,0,0.04)] p-8">
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-6 self-stretch w-full">
          {DATA.map((item, index) => (
            ...
            >
              <Icon name={item.icon} className="w-6 h-6 text-foreground" />
			...
			<div className="max-w-container mx-auto grid grid-cols-1 md:grid-cols-2 gap-[26px] mb-11.5 px-4 lg:px-0">
				<div className="relative overflow-hidden rounded-xl bg-accent-purple px-9 py-5 text-white flex items-center min-h-[159px]">
					<Image 
					...
					<div className="relative z-10 flex gap-6 items-center">
						 <div className="shrink-0 flex items-center justify-center w-[48px]">
						 	 <Image 
						 ...
						 <div>
							 <h3 className="text-[20px] font-bold leading-[28px]">
								 Built for point-of-care speed
							 </h3>
							 <p className="mt-2.5 text-[16px] font-normal leading-[24px] text-white/90">
								 Short, prioritized suggestions designed for pre-visit planning and in-visit workflows.
							 </p>
						 </div>
					</div>
				</div>
				...
				<div className="relative overflow-hidden rounded-xl bg-accent-purple px-9 py-5 text-white flex items-center min-h-[159px]">
					...
					/>
					<div className="relative z-10 flex gap-6 items-center">
						 <div className="shrink-0 flex items-center justify-center w-[64px]">
						 	 <Image 
						 ...
						 <div>
							 ...
							 <p className="mt-2.5 text-[16px] font-normal leading-[24px] text-white/90">
								 Deliver recommendations where your teams work (EHR workflows, queues, exports)
							 </p>
						 </div>
					</div>
				</div>
