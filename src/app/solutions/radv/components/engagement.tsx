...
const TERMS = [
  {
    ...
    body: "You pay a license fee for the year. Not per chart, and not per code we validate.",
  },
  {
    title: "Priced to your size",
    body: "The fee is based on how many contracts and lives you run, and stays fixed for the year. Add contracts or payment years without renegotiating.",
  },
  {
...
/**
 * Engagement - the pricing and engagement model, published. No competitor in
 * this category puts this on their site.
 */
export function Engagement() {
  return (
    <section className="apple-section-gray py-20 md:py-24" aria-labelledby="engagement-heading">
      <div className="container-main">
        ...
        >
          {TERMS.map((term) => (
            <li
              key={term.title}
              className="rounded-[28px] bg-white border border-border p-7 md:p-8 h-full"
            >
